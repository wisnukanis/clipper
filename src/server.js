...
const envGroups = [
  ...
  },
  {
    ...
    fields: [
      ...
      field("MIXROUTE_API_KEY", "MixRoute key", true),
      field("MIXROUTE_BASE_URL", "MixRoute base URL"),
      field("MIXROUTE_MODEL", "MixRoute model"),
      field("MIXROUTE_MODELS", "MixRoute fallback models"),
...
app.get("/api/state", async (_req, res) => {
  res.json({
    config: {
      ...
      maxScheduledPostsPerDay: Number(process.env.MAX_SCHEDULED_POSTS_PER_DAY || 5),
      autoDiscoverDailyQueueLimit: Number(process.env.AUTO_DISCOVER_DAILY_QUEUE_LIMIT || process.env.MAX_SCHEDULED_POSTS_PER_DAY || 5),
